...
Si necessiteu automatitzacions d'esvaïment d'entrada/sortida juntament amb el control de la intensitat de la funció, llavors l'ús d'un botó de la consola virtual ![](/basics/button.png)[](../button) en combinació amb un Slider en mode Submaster és el que esteu cercant.
...
Per exemple, un submestre pot controlar la intensitat d'una funció adjuntada a un botó [](../button) o els nivells de canal associats a un control lliscant en mode de nivell.  
