...
Els controls lliscants s'utilitzen per a dos propòsits diferents: [Fixture](/basics/glossary-and-concepts#fixtures) ajust del nivell del canal i [Funció](/basics/glossary-and-concepts#functions) reproducció i ajust de la intensitat. Qualsevol control lliscant pot operar en qualsevol d'aquests modes i cada mode té les seves pròpies opcions de configuració.
