...
| **Invert** | Invert the current selection. If you have channels 1, 3 and 5 selected from all fixtures, clicking this button will unselect channels 1, 3 and 5 and instead select channels 2, 4 and 6 from those fixtures. |
