...
| ![](/basics/script.png) | Create a new [Script](/basics/glossary-and-concepts#script) and edit it using the [Script Editor](/function-manager/script-editor). (Shortcut: CTRL+7) |
