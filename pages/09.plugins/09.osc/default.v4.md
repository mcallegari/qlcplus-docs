...
You can enter the **OSC path** and QLC+ will calculate the channel number for you. It is basically a 16-bit hash of the path that QLC+ uses to represent a OSC input.  
