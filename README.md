...
![example workflow](https://github.com/mcallegari/qlcplus-docs/actions/workflows/main.yml/badge.svg) [![GitHub Issues or Pull Requests](https://img.shields.io/github/issues/mcallegari/qlcplus-docs)](https://github.com/mcallegari/qlcplus-docs/issues) [![Mozilla HTTP Observatory Grade](https://img.shields.io/mozilla-observatory/grade-score/docs.qlcplus.org?publish)](https://observatory.mozilla.org/analyze/open-fixture-library.org)
...
## Contributing
Contributing to the QLC+ documentation is easy! If you find a problem but don't have the time to fix it, you can [open an issue](https://github.com/mcallegari/qlcplus-docs/issues) to let us know about it. Otherwise expand the below instructions to edit a page right here in GitHub:
<details>
...
### Help wanted
Click the badge below to see the currently confirmed issues with the documentation.
